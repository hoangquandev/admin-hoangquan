...
// import { addProduct } from '../../api/products'; // Thay thế bằng API tương ứng cho sản phẩm

const NewProductForm = ({ onChange }) => {
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            status: Yup.string().required('Bắt buộc'), // Thêm validation cho trường status
        }),
    ...
    return (
        <div className="w-full mx-auto max-w-[520px] bg-white p-10">
            <div className="text-center mb-10">
                <h5 className="text-xl font-medium">Thêm sản phẩm mới</h5>
            </div>
